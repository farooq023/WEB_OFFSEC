    ...
    >
      ...
      >
        ...
        <Button
          ...
          onClick={() => generateSSLReport(sslResults, user, image)}
        >
          Get report
        </Button>
              ...
              datasets: [
                {
                  ...
                  data: [
                    supported[0] == "-" ? 0 : supported.length,
                    bypassing[0] == "-" ? 0 : bypassing.length,
                  ],
        ...
        >
          <Table style={{ width: "39vw" }}>
            <thead>
              <tr>
                <th scope="col">
                  Bypassed Ciphers ({bypassing[0] == "-" ? 0 : bypassing.length}
                  )
                </th>
              </tr>
            </thead>
